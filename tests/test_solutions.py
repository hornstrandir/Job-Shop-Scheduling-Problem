...
class TestSolution(unittest.TestCase):
    def test_optimum_ta01(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta01"
            },
        )
        env.reset()
    ...
    def test_optimum_ta41(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta41"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta42(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta42"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta43(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta43"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta44(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta44"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta45(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta45"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta46(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta46"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta47(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta47"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta48(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta48"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta49(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta49"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta50(self):
        ...
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta50"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
    ...
    def test_optimum_ta51(self):
        env = JssEnv(
            env_config={
                "instance_path": f"{str(Path(__file__).parent.absolute())}/../data/instances/ta51"
            },
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
