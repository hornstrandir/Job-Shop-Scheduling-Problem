...
from utils.CustomCallbacks import *
from utils.env_config import env_config
from algorithms.fcnn_model import *
...
def train_func():
    ...
    default_config = {
        ...
        'rollout_fragment_length': 1032,  # TO TUNE
    ...
    config['env_config'] = {'instance_path': 'data/instances/ta07', 'disable_env_checking': True}
    

    config = with_common_config(config)
    config['env'] = 'JssEnv-v0'
    config['seed'] = 0
